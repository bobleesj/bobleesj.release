...
# -*- coding: utf-8 -*-
#
# test-release documentation build configuration file, created by
...
modindex_common_prefix = ["test-release"]
...
basename = "test-release".replace(" ", "").replace(".", "")
...
latex_documents = [
    ("index", "test-release.tex", "test-release Documentation", ab_authors, "manual"),
]
...
man_pages = [("index", "test-release", "test-release Documentation", ab_authors, 1)]
