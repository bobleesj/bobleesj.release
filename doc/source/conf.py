...
def _get_github_latest_release(org: str, repo_name: str) -> str:
    """Get the highest version release (including prereleases) of a GitHub repository."""
    ...
    # Return the highest version release
...
org = "bobleesj-test-org"
repo_name = "bobleesj.release"
latest_verion_from_github = _get_github_latest_release(org, repo_name)
print("\n=========")
print(f"The latest release of the repository {repo_name} is {latest_verion_from_github}.")

# version_tag = _get_github_repo_stars(project)
